...
namespace Nicholas.Untilty
{
    public class XmlHelper : IDisposable
    {
        ...
        /// <returns></returns>
        public string GetXmlNodeValue(string filename, string xpath, string nodeName)
        {
            XmlNodeList _xmlNodeList = GetXmlNodeListByXpath(filename, "SystemInfo");
